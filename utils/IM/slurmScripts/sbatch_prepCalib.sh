...
#------------------------------------------------------
# This script is used to prepare the calibrator data
#------------------------------------------------------
...
DIR_OUT='/wrk/group/corona/peijin/LC4/MSclb/' #/proj/group/corona/radio/data/LC4_ciara/MSclb3/
SASID='L401011'
...
srun singularity exec -B /proj/group/corona/radio/,/wrk/group/corona/ \
    ...
    NDPPP msin=$MSDIR steps=[flag,averager]  \
    flag.type=aoflagger  flag.strategy=LOFAR-LBA-default.rfis \
    averager.timestep=40 \
